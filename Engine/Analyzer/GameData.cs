...
public struct GameData
{
    ...
    public GameData(IEnumerable<string> humanPlayerNames, List<DetailsPlayer?> specialRoleTeams,
        Dictionary<string, int> playerKills, Dictionary<string, double> dictOfLifePercentages, string lastEvolution,
        List<DetailsPlayer> alivePlayers, List<DetailsPlayer> spawns)
    {
