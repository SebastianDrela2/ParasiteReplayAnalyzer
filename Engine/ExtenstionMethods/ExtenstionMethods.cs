...
public static class ExtenstionMethods
{
    ...
    public static void UpdatePlayerStats(this List<PlayerStats> listOfPlayerStats, PlayerStats incomingPlayerStats,
    ...
    {
        alienAi = new DetailsPlayer(alienAi.Color, alienAi.Control, alienAi.Handicap, alienAi.Hero, "Alien AI",
            alienAi.Observe,
    ...
    {
        stationSecurityAi = new DetailsPlayer(stationSecurityAi.Color, stationSecurityAi.Control,
            stationSecurityAi.Handicap, stationSecurityAi.Hero, "Station Security", stationSecurityAi.Observe,
            stationSecurityAi.Race, stationSecurityAi.Result, stationSecurityAi.TeamId,
            new Toon(2, "Station-Security", 0, 0), stationSecurityAi.WorkingSetSlotId);
