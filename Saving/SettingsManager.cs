...
public class SettingsManager
{
    ...
    {
        if (!File.Exists(SettingsPath)) return new Settings(GetDefaultReplaysPath(), 10);
    ...
    {
        var settingsFilePath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments),
            "ParasiteReplayAnalyzer", "Settings");
